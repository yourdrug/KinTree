...
#
# from api.dependencies.base_dependencies import get_relation_service
...
#     service: RelationService = Depends(get_relation_service(master=True)),
# ) -> ParentChildResponse:
#     """
...
#     service: RelationService = Depends(get_relation_service(master=False)),
# ) -> FamilyGraphResponse:
#     """
