...
def load_model_modules() -> None:
    ...
    model_modules: tuple = (
        "shared.infrastructure.db.basemodel",
        "genealogy.infrastructure.db.models.family",
        "genealogy.infrastructure.db.models.parent_child",
        "genealogy.infrastructure.db.models.person",
        ...
        "identity.infrastructure.db.models.email_token",
    )
